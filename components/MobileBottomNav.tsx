...
export const MobileBottomNav: React.FC<Props> = ({ activeTool, onSelect, lang }) => {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-slate-900/90 backdrop-blur-lg border-t border-slate-200 dark:border-slate-800 z-40 px-2 pb-safe pt-2 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] overflow-x-auto no-scrollbar">
      <div className="flex justify-between items-center pb-1 min-w-max px-2 gap-2">
        {tools.map((tool) => {
